...
const experience = [
  {
    ...
    period: "2022 - Present",
    description:
      "Leading frontend development for customer-facing applications.",
  },
  {
    company: "Startup Inc",
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              15+ years experience in IT infrastructure, now passionate about
              building modern web applications. Combining network security
              expertise with full-stack development skills.
            </p>
          </section>

          {/* Bio Section */}
          <section className="mb-16 text-indigo-700">
            <h2 className="text-2xl font-bold text-gray-900 mb-6">
              My Journey
            </h2>
            <div className="prose prose-lg text-indigo-700">
